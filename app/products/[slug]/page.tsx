...
function getWeightOptions(portion: string) {
    ...
    if (match) {
        ...
        if (base >= 1000) {
            return [
                { label: `${(base * 0.5 / 1000).toFixed(1)}kg`, sub: "Half Cut", multiplier: 0.5 },
                { label: `${(base / 1000).toFixed(1)}kg`, sub: "Full Cut", multiplier: 1 },
                { label: `${(base * 1.5 / 1000).toFixed(1)}kg`, sub: "Large Cut", multiplier: 1.5 },
            ]
        }
        return [
            { label: `${base}g`, sub: "Single Serving", multiplier: 1 },
            { label: `${base * 2}g`, sub: "Duo Portion", multiplier: 2 },
            { label: `${base * 3}g`, sub: "Large Cut", multiplier: 3 },
        ]
    }
    return [
        { label: "200g", sub: "Single Serving", multiplier: 1 },
        { label: "400g", sub: "Duo Portion", multiplier: 2 },
        { label: "600g", sub: "Large Cut", multiplier: 3 },
    ]
}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-7 space-y-4">
                        ...
                        <div className="grid grid-cols-4 gap-4">
                            {[product.image_url, product.image_url, product.image_url, product.image_url].slice(1).map((img, idx) => (
                                <div
                                    key={idx}
                                    className={`aspect-square rounded-lg overflow-hidden transition-opacity ${idx === 0
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-8">
                            <div className="text-white">
                                <p className="text-3xl font-bold italic">
                                    &ldquo;The finest beef experience you&apos;ll ever taste.&rdquo;
                                </p>
